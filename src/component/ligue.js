    ...
    render() {
        ...
        if (loggedInUser == null) {
            ...
            return(
                <div>
                    <div id="favoris">
                        <p>Ligues favorites :</p>
                        {this.state.data.map(datas =>
                            <div>
                                <div className={"ligue-favori"}>
                                    <input id={datas.id} checked={this.state.checked} type={"radio"} onChange={() => this.handleInputChange(datas.id)} />
                        ...
                        {this.state.ligues.map(ligue =>
                            <div className={"ligue"}>
                                <div className={"ligue-donnees"}>
                                    <input id={ligue.id}  type="radio" onChange={() => this.handleInputChange(ligue.id)} />
